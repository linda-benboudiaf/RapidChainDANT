...
//L'idee est de crée une ArrayList afin de stocker les blocks puis l'importer dans un fichier JSON.
		...
		/*
		 * Class isChainValid : Boolean.
		 * Une boucle qui parcours ArrayList afin de verifie:
		 * Le Hash du block précédent est égale a la valeur de "PreviousHash" du block en cours.
		 * Pareil pour le hash qui dèja stocké dans la chaine et celui qu'on vient de calculé.
		 */
		...
		public static Boolean isChainValid() {
			...
			// On compare le précédent hash et le hash précédent stocké dans le block en cours.
		...
		public static void addBlocks(Block newBlock) {
